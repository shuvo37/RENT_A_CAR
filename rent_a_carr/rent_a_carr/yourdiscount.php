...
if ($result1->num_rows == 0) {
    ...
    $_SESSION['user_discount'] = 0; // Initialize user_discount with a default value
    showAlert('You have not rated yet.', 'info', 'rating.php');
} else {
    // Display user rating if exists
    $five = 5;
    $row = $result1->fetch_assoc();
    $_SESSION['user_discount'] = intval($row['user_rating']) / $five;
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card center-content">
                ...
                <div class="card-body">
                    <p><strong><?php echo 'You have 100% discount for ' . intval($_SESSION['user_discount']) . ' order(s)' ?></strong></p>
                </div>
